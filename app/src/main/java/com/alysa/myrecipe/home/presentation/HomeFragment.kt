    ...
    override fun onCreateView(
        ...
        val runnable = object : Runnable {
            override fun run() {
                ...
                val newPosition =
                    if (currentPosition == carouselAdapter.itemCount - 1) 0 else currentPosition + 1
            ...
            override fun onPageSelected(position: Int) {
                ...
                if (position == carouselAdapter.itemCount - 1) {
                    ...
                    Handler().postDelayed(
                        ...
                        2000
                    ) // Ganti 2000 dengan jeda yang diinginkan sebelum kembali ke page pertama (dalam milidetik)
                }
            }
