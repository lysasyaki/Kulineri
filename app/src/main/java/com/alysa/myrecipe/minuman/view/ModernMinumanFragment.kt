...
class ModernMinumanFragment : Fragment(), RecipeMakananView {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_modern_minuman, container, false)

        var recyclerView = view.findViewById<RecyclerView>(R.id.rv_minuman_modern)
        ...
        val refresh =  view.findViewById<SwipeRefreshLayout>(R.id.swipe)
